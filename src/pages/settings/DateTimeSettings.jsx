		...
		>
			...
			<FormControl>
				<StyledSelect
					...
					value={formState.date_and_time_format}
					onChange={handleChange}
				>
			...
			<FormControl>
				<StyledSelect
					...
					value={formState.default_schedule}
					onChange={handleChange}
				>
					<MenuItem value="24/5">24/5</MenuItem>
					<MenuItem value="24/7">24/7</MenuItem>
					<MenuItem value="Monday - Friday 8am - 5pm with U.S. Holidays">
						Monday - Friday 8am - 5pm with U.S. Holidays
					</MenuItem>
				</StyledSelect>
			</FormControl>
